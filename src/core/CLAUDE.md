...
`Scrape`, `Crawl`, `Watch`, `Map`, `Endpoints`, `Extract`, `Search`, `Embed`, `Debug`, `Doctor`, `Query`, `Retrieve`, `Ask`, `Summarize`, `Evaluate`, `Train`, `Suggest`, `Sources`, `Domains`, `Stats`, `Status`, `Dedupe`, `Ingest`, `Sessions`, `Research`, `Screenshot`, `Completions`, `Mcp`, `Serve`, `Preflight`, `Smoke`, `Stack`, `Setup`, `Migrate`, `Config`.
