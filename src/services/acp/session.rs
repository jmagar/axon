...
use crate::services::types::{AcpAdapterCommand, AcpBridgeEvent, AcpModeUpdate};
...
> {
    ...
    crate::core::logging::log_info(&msg);
    emit(
        tx,
        ServiceEvent::Log {
            level: LogLevel::Info,
...
pub(super) async fn apply_config_and_model(
    ...
    gemini_adapter: bool,
    tx: &Option<mpsc::Sender<ServiceEvent>>,
) -> Result<Vec<crate::services::types::AcpConfigOption>, String> {
...
async fn apply_model_config(
    ...
    tx: &Option<mpsc::Sender<ServiceEvent>>,
) -> Result<Option<Vec<crate::services::types::AcpConfigOption>>, String> {
...
mod tests {
    ...
    use crate::services::types::AcpMcpServerConfig;
