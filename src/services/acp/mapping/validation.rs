...
use crate::services::types::{AcpPromptTurnRequest, AcpSessionProbeRequest};

// ── Validation helpers ──────────────────────────────────────────────────────

pub fn validate_adapter_command(
    adapter: &crate::services::types::AcpAdapterCommand,
...
mod tests {
    use super::*;
    use crate::services::types::AcpAdapterCommand;
