use crate::core::config::{Config, SessionWatchConfig};
use crate::ingest::sessions::watch::{
...
pub(crate) async fn run_watch_with_event_sink(
    cfg: &Config,
    service_context: &ServiceContext,
    options: SessionWatchConfig,
...
pub async fn watch_status(
    ...
    crate::ingest::sessions::checkpoint::watch_status(pool.as_ref(), limit as i64)
        .await
...
impl SessionWatchIngestor for ServiceSessionWatchIngestor {
    async fn ingest_prepared_request_for_watch(
        ...
        let outcome = crate::services::ingest::ingest_sessions_prepared_with_progress(
            cfg, request, None, None,
        )
        .await
...
impl From<crate::ingest::sessions::checkpoint::SessionWatchStatus> for SessionWatchStatus {
    fn from(status: crate::ingest::sessions::checkpoint::SessionWatchStatus) -> Self {
        Self {
...
impl From<crate::ingest::sessions::checkpoint::SessionWatchError> for SessionWatchError {
    fn from(error: crate::ingest::sessions::checkpoint::SessionWatchError) -> Self {
        Self {
...
impl From<crate::ingest::sessions::watch::SessionWatchSmokeReport> for SessionWatchSmokeReport {
    fn from(report: crate::ingest::sessions::watch::SessionWatchSmokeReport) -> Self {
        Self {
