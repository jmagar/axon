...
use crate::services::acp::{AcpClientScaffold, PermissionResponderMap};
...
mod tests {
    use super::*;
    use crate::services::types::{AcpSessionUpdateEvent, AcpSessionUpdateKind};
    ...
    fn usage_update_does_not_become_completion_usage_snapshot() {
        ...
        handle_completion_bridge_event(
            &AcpBridgeEvent::UsageUpdate(crate::services::types::AcpUsageUpdate {
        ...
        handle_completion_bridge_event(
            &AcpBridgeEvent::TurnResult(crate::services::types::AcpTurnResultEvent {
                session_id: "session-1".to_string(),
