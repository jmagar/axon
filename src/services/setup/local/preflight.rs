...
pub(super) async fn check_command<const N: usize>(
    ...
    let result =
        crate::services::setup::diagnostics::check_command(binary, args, Duration::from_secs(10))
            .await;

    let status = match result.status {
        crate::services::setup::diagnostics::CommandStatus::Ok => LocalSetupStatus::Ok,
        crate::services::setup::diagnostics::CommandStatus::Failed
        | crate::services::setup::diagnostics::CommandStatus::NotFound
        | crate::services::setup::diagnostics::CommandStatus::TimedOut => LocalSetupStatus::Error,
    };
