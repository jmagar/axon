...
#[utoipa::path(
    ...
    responses((status = 200, description = "Embed job status", body = serde_json::Value), (status = 404, description = "Job not found", body = crate::web::server::error::ErrorBody)),
    tag = "jobs"
)]
...
#[utoipa::path(
    ...
    responses((status = 200, description = "Extract job status", body = serde_json::Value), (status = 404, description = "Job not found", body = crate::web::server::error::ErrorBody)),
    tag = "jobs"
)]
...
#[utoipa::path(
    ...
    responses((status = 200, description = "Ingest job status", body = serde_json::Value), (status = 404, description = "Job not found", body = crate::web::server::error::ErrorBody)),
    tag = "jobs"
)]
