...
use self::cli::commands::{
    ...
    run_extract, run_ingest, run_map, run_mcp, run_memory, run_migrate, run_monitor, run_palette,
    run_purge, run_query, run_refresh, run_research, run_retrieve, run_scrape, run_screenshot,
    run_search, run_serve, run_sessions, run_setup, run_sources, run_stats, run_status,
    run_suggest, run_summarize, run_sync, run_train, run_update, run_watch, start_url_from_cfg,
};
