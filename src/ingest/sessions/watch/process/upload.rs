...
use crate::ingest::sessions::checkpoint::SessionFileMetadata;
...
mod tests {
    use super::*;
    use crate::core::config::SessionWatchConfig;
    use crate::ingest::sessions::watch::validate::SessionProvider;
