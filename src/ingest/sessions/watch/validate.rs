...
impl SessionWatchRoots {
    ...
    pub fn from_config(_cfg: &crate::core::config::Config) -> Result<Self> {
...
pub(crate) fn validate_event_path_missing_ok(
    roots: &SessionWatchRoots,
    path: &Path,
...
fn canonical_provider_roots(roots: &SessionWatchRoots) -> Vec<(SessionProvider, PathBuf)> {
    [
