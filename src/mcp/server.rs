...
use rmcp::{
    ...
    model::{
        AnnotateAble, CallToolRequestParams, CallToolResult, CancelTaskParams, CancelTaskResult,
        CreateTaskResult, ExtensionCapabilities, GetTaskInfoParams, GetTaskPayloadResult,
        GetTaskResult, GetTaskResultParams, InitializeRequestParams, InitializeResult,
        ListResourcesResult, ListTasksResult, Meta, PaginatedRequestParams, RawResource,
        ReadResourceRequestParams, ReadResourceResult, Resource, ResourceContents,
        ServerCapabilities, ServerInfo, TasksCapability,
    },
