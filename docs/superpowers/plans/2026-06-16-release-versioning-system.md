...
- [ ] Create `/home/jmagar/workspace/axon/release/components.toml` with this exact content:
...
- [ ] Update `/home/jmagar/workspace/axon/xtask/Cargo.toml` dependencies:
...
- [ ] Add `/home/jmagar/workspace/axon/xtask/src/checks/release_versions.rs`.
...
- [ ] Add `/home/jmagar/workspace/axon/xtask/src/checks/release_versions_tests.rs`.
...
- [ ] Update `/home/jmagar/workspace/axon/xtask/src/checks.rs`:
...
- [ ] Update `/home/jmagar/workspace/axon/xtask/src/main.rs` command enum:
...
- [ ] Refactor `/home/jmagar/workspace/axon/xtask/src/checks/version_sync.rs` only enough to avoid duplicate file lists:
...
- [ ] Update the command help text in `/home/jmagar/workspace/axon/xtask/src/main.rs`:
...
- [ ] Update `/home/jmagar/workspace/axon/.github/workflows/ci.yml`.
...
- [ ] Update `/home/jmagar/workspace/axon/.github/workflows/auto-tag.yml`.
...
- [ ] Update `/home/jmagar/workspace/axon/tests/workflow_shapes.rs`.
...
- [ ] Update `/home/jmagar/workspace/axon/CLAUDE.md` release section:
...
- [ ] Update `/home/jmagar/workspace/axon/docs/contributing/repo/rules.md` so it no longer says `.claude-plugin/plugin.json` should carry a version. It must say the plugin manifest has no `version` key.
