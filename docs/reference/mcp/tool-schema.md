...
- Direct actions: `ask`, `brand`, `diff`, `doctor`, `endpoints`, `evaluate`, `help`, `map`, `prune`, `purge`, `query`, `research`, `retrieve`, `screenshot`, `search`, `source`, `status`, `suggest`, `summarize`
