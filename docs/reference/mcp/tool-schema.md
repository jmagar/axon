# Axon MCP Tool Schema (Current Generated Snapshot)
Last Modified: 2026-06-27

<!-- AUTO-GENERATED by scripts/generate_mcp_schema_doc.py — do not edit manually -->

> Pipeline-unification note: this generated file describes the current
> pre-unification MCP surface. The target clean-break source of truth is
> `docs/pipeline-unification/surfaces/tool-contract.md` plus
> `docs/pipeline-unification/schemas/mcp-tool-schema.md`. Regenerate this file
> from the new `axon-mcp` action registry during the cutover.
