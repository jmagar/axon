...
- Direct actions: `ask`, `brand`, `diff`, `doctor`, `domains`, `elicit_demo`, `endpoints`, `evaluate`, `help`, `map`, `purge`, `query`, `research`, `retrieve`, `screenshot`, `search`, `source`, `sources`, `stats`, `status`, `suggest`, `summarize`
