...
<!-- source inputs: sha256:b62a4d999285f52a28e5373bea2a56e572471b257768af77e9fb78c9f7212225 -->
...
| `crates/axon-jobs/src/migrations` | `sha256:8fd206e8313f599006b520d1504f2cb65cfe140650a8ab975722ab784f86b6f7` |
...
41 tables, 87 indexes, 29 migration files parsed from `crates/axon-jobs/src/migrations`, `crates/axon-ledger/src/migrations`, `crates/axon-graph/src/migrations`, and `crates/axon-memory/src/migrations`. See `tables`/`indexes`/`foreign_keys`/`migrations`/`divergences` in the generated JSON artifact for full detail.
