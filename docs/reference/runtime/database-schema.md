...
<!-- source inputs: sha256:54b8f59bbbad03745da97e072f3d9eda2313b61f5bcabc5290131e985c308fbc -->
...
| `crates/axon-jobs/src/migrations` | `sha256:e0fe208c44a81ccc7c7812602096d2d15d749f92ec5c26998b4a951addf49044` |
...
| `xtask/src/schemas/database_defs.rs` | `sha256:b5fabe32118de44eddb351166c015e4ae2e834633814ac084c5b66ac12bab7b1` |
...
28 tables, 68 indexes, 35 migration files parsed from `crates/axon-jobs/src/migrations`, `crates/axon-ledger/src/migrations`, `crates/axon-graph/src/migrations`, and `crates/axon-memory/src/migrations`. See `tables`/`indexes`/`foreign_keys`/`migrations`/`divergences` in the generated JSON artifact for full detail.
