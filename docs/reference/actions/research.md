...
|---|---|
| CLI | `axon research ...` |
| REST | `POST /v1/research` (Implemented) |
| MCP | `{ "action": "research" }` |
| Service | `services::search::synthesis::research` |

Parity notes: HTTP applies a 35-second server-side timeout. Streaming remains deferred.
