...
fn removed_cli_commands_are_absent_from_help_and_parser() {
    ...
    for removed in ["embed", "ingest", "crawl", "code-search", "code-search-watch", "purge", "dedupe", "refresh", "fresh"] {
    ...
    assert!(parse_cli(["axon", "scrape", "https://example.com"]).is_ok());
