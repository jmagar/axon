...
upstream_refs:
  - "https://github.com/jmagar/rmcp-template/blob/main/docs/contributing/rust.md"
...
The canonical reference is [rmcp-template/docs/contributing/rust.md](https://github.com/jmagar/rmcp-template/blob/main/docs/contributing/rust.md).
...
See [rmcp-template/docs/contributing/rust.md](https://github.com/jmagar/rmcp-template/blob/main/docs/contributing/rust.md)
