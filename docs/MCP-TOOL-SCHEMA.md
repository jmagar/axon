...
- Lifecycle families: `artifacts`, `crawl`, `doctor`, `domains`, `embed`, `extract`, `graph`, `help`, `ingest`, `refresh`, `sources`, `stats`, `status`
- Direct actions: `ask`, `elicit_demo`, `export`, `map`, `query`, `research`, `retrieve`, `scrape`, `screenshot`, `search`
