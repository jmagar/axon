...
export type paths = {
    ...
    "/v1/watches/{watch_id}/exec": { post: operations["exec_watch"] };
...
export type operations = {
    ...
    "exec_watch": { method: "post"; path: "/v1/watches/{watch_id}/exec"; operationId: "exec_watch"; parameters: { query: Record<string, never>; path: { "watch_id": string } }; requestBody: components['schemas']['WatchExecRequest']; responses: { "200": unknown; "401": components['schemas']['ErrorBody']; "403": components['schemas']['ErrorBody']; "404": components['schemas']['ErrorBody']; "502": components['schemas']['ErrorBody'] }; security: "bearerAuth" | "oauth2" };
