...
See `CLAUDE.md` in this directory for the canonical environment variable reference.
The root repository `CLAUDE.md` also documents shared infrastructure variables.
