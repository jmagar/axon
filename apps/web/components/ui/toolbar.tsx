...
const toolbarButtonVariants = cva(
  "inline-flex cursor-pointer items-center justify-center gap-2 whitespace-nowrap rounded-md font-medium text-sm outline-none transition-[color,box-shadow] hover:bg-[var(--surface-primary)] hover:text-[var(--text-primary)] focus-visible:border-[var(--axon-primary)] focus-visible:ring-[3px] focus-visible:ring-[rgba(135,175,255,0.3)] disabled:pointer-events-none disabled:opacity-50 aria-checked:bg-[var(--surface-primary-active)] aria-checked:text-[var(--axon-primary)] aria-invalid:border-destructive aria-invalid:ring-destructive/20 dark:aria-invalid:ring-destructive/40 [&_svg:not([class*='size-'])]:size-4 [&_svg]:pointer-events-none [&_svg]:shrink-0",
  {
    defaultVariants: {
      size: 'default',
      variant: 'default',
