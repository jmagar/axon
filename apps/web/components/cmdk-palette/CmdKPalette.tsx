...
export function CmdKPalette() {
  ...
  const executeMode = useCallback(
    (mode: ModeDefinition, input: string) => {
      ...
      const unsub = subscribe((msg: WsServerMsg) => {
        ...
        if (execIdRef.current && ctxExecId && ctxExecId !== execIdRef.current) return
  ...
  const paletteContent = (
    <>
      {/* Backdrop — design system: bg-black/60 backdrop-blur-sm for modal scrims */}
      ...
      {/* Panel */}
      {/* biome-ignore lint/a11y/noStaticElementInteractions: stopPropagation to prevent backdrop dismiss; panel itself is not interactive */}
      <div
        ...
        style={{
          ...
          maxHeight: '70vh',
          // Design system: modal/drawer overlay = rgba(10,18,35,0.97)
          background: 'rgba(10, 18, 35, 0.97)',
          // Design system: --border-standard for dropdown/dialog panels
          border: '1px solid var(--border-standard)',
          borderRadius: 14,
          // Design system: --shadow-xl for elevated panels
            ...
            >
              <button
                ...
                style={{
                  ...
                  border: 'none',
                  cursor: 'pointer',
                  // Design system: --text-muted for subdued interactive text
              ...
              {/* Mode chip — design system mode chip active pattern */}
              <span
                className="ui-chip"
                style={{
                  color: 'var(--axon-primary)',
