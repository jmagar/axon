...
const COMMENT_PROMPT_RULES = dedent`
...
const COMMENT_PROMPT_TASK = dedent`
...
export interface GetCommentPromptOptions {
  messages: ChatMessage[]
}

export function getCommentPrompt(editor: SlateEditor, { messages }: GetCommentPromptOptions) {
  ...
  return buildStructuredPrompt({
    ...
    examples: COMMENT_PROMPT_EXAMPLES,
    history: formatTextFromMessages(messages),
    instruction: getLastUserInstruction(messages),
    rules: COMMENT_PROMPT_RULES,
    task: COMMENT_PROMPT_TASK,
  })
}
