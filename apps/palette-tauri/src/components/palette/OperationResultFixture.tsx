  ...
  const cases: Array<{ title: string; action: PaletteAction; run: Extract<RunState, { kind: "success" | "error" }> }> = [
    {
      ...
      action: actionFor("jobs-status"),
      run: {
        kind: "error",
        title: "Job status failed",
        subtitle: "jobs-status not-a-uuid",
      ...
      run: {
        ...
        result: {
          ...
          payload: {
            ...
            source_jobs: [{ id: "018f3d8a-64b0-7c51-9a84-f3a39b5a5f18", status: "queued", url: "https://qdrant.tech/documentation/" }],
          },
        },
      },
    },
      ...
      run: {
        ...
        result: {
          ...
          payload: {
            ...
            source_jobs: [{ id: "018f3d8a-64b0-7c51-9a84-f3a39b5a5f18", status: "queued", url: "https://docs.anthropic.com/" }],
          },
        },
      },
    },
