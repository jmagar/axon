...
enum class OperationMode(
    ...
    // Page, site, and general sources share the canonical source endpoint.
    Scrape("Scrape", Icons.Filled.ContentPaste, openApiRoute("POST", "/v1/sources")),
    SourceSite("Index site", Icons.Filled.TravelExplore, openApiRoute("POST", "/v1/sources")),
    Source("Source", Icons.Filled.CloudDownload, openApiRoute("POST", "/v1/sources")),
