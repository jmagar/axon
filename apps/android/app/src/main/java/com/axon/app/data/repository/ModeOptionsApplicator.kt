...
interface ModeOptionsApplicator {
    ...
    suspend fun apply(req: SiteSourceRequest): SiteSourceRequest

    suspend fun apply(req: MapRequest): MapRequest

    suspend fun apply(req: SearchWebRequest): SearchWebRequest

    suspend fun apply(req: SourceRequest): SourceRequest
}
...
object NoopModeOptionsApplicator : ModeOptionsApplicator {
    ...
    override suspend fun apply(req: SiteSourceRequest): SiteSourceRequest = req
    ...
    override suspend fun apply(req: SourceRequest): SourceRequest = req
}
