...
class GeneratedClientBoundaryTest {
    ...
    fun generatedModelsAreOnlyImportedByGeneratedAdapter() {
        ...
        val offenders = root.walkTopDown()
            ...
            .filterNot { it.invariantSeparatorsPath.endsWith("/core/api/GeneratedAxonApi.kt") }
            .filterNot { it.invariantSeparatorsPath.endsWith("/core/api/openapi/GeneratedClientBoundaryTest.kt") }
