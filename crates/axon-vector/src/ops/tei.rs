...
#[cfg(test)]
pub use tei_client::QUERY_INSTRUCTION;
#[cfg(test)]
pub use tei_client::prepend_query_instruction;
...
pub struct PreparedDoc {
    pub(in crate::ops) url: String,
    pub(in crate::ops) domain: String,
    pub(in crate::ops) chunks: Vec<String>,
    /// "embed" for crawl path, "github"/"reddit"/"youtube"/"sessions" for ingest.
    pub(in crate::ops) source_type: String,
    /// "markdown" for crawl path, "text" for ingest sources.
    pub(in crate::ops) content_type: &'static str,
    ...
    pub(in crate::ops) extractor_name: Option<String>,
    ...
    pub(in crate::ops) structured: Option<StructuredPayload>,
    ...
    pub(in crate::ops) chunk_extra: Vec<serde_json::Value>,
    ...
    pub(in crate::ops) local_legacy_fragment_url: Option<String>,
    ...
    pub(in crate::ops) chunk_point_ids: Vec<uuid::Uuid>,
}
...
impl PreparedDoc {
    ...
    #[cfg_attr(not(test), allow(dead_code))]
    pub fn chunk_extra(&self) -> &[serde_json::Value] {
        &self.chunk_extra
    }
    ...
    #[cfg_attr(not(test), allow(dead_code))]
    pub fn structured(&self) -> Option<&StructuredPayload> {
...
impl StructuredPayload {
    ...
    /// [`axon_core::structured::StructuredDataPass::dominant`].
    pub(crate) fn from_pass(
        pass: &axon_core::structured::StructuredDataPass,
        max_bytes: usize,
    ) -> Option<Self> {
