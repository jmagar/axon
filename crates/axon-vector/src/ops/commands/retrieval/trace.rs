...
use crate::ops::input::code::SymbolKind;
...
#[derive(Clone, Debug)]
#[allow(dead_code)]
pub struct CandidateRankingTrace {
...
pub fn score_and_filter_candidates(
...
#[allow(dead_code)]
pub fn score_and_filter_candidates_with_trace(
    candidates: &[RetrievedCandidate],
    query_tokens: &[String],
    policy: &CandidateScorePolicy<'_>,
...
pub fn dropped_candidate_trace(
...
#[allow(dead_code)]
pub fn score_rrf_candidates_with_trace(
    candidates: &[RetrievedCandidate],
    query_tokens: &[String],
    policy: &CandidateScorePolicy<'_>,
) -> (Vec<RetrievedCandidate>, Vec<CandidateRankingTrace>) {
