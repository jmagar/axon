...
pub(in crate::ops::commands::ask::context) struct RerankParams<'a> {
    pub(in crate::ops::commands::ask::context) authoritative_domains: &'a [String],
    pub(in crate::ops::commands::ask::context) authoritative_boost: f64,
    pub(in crate::ops::commands::ask::context) product_authority_boost: f64,
    pub(in crate::ops::commands::ask::context) min_relevance_score: f64,
}

#[cfg(test)]
pub(in crate::ops::commands::ask::context) fn is_rrf_mode(
...
pub(in crate::ops::commands::ask::context) fn apply_mode_aware_rerank(
    is_rrf: bool,
...
pub(in crate::ops::commands::ask::context) fn apply_mode_aware_rerank_with_trace(
    is_rrf: bool,
...
pub(in crate::ops::commands::ask::context) fn rerank_with_optional_trace(
    ask_explain: bool,
    rrf_mode: bool,
    dense_score_kind: AskExplainScoreKind,
...
pub(in crate::ops::commands::ask::context) fn retrieval_score_kind(
    vector_mode: VectorMode,
    rrf_mode: bool,
) -> AskExplainScoreKind {
    if rrf_mode {
