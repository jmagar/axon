...
use axon_core::ask_explain::{AskExplainRetrieval, AskExplainScoreKind};
use axon_core::config::Config;
use axon_core::logging::{log_debug, log_info};
...
struct BuiltRetrievalCandidates {
    ...
    mode: crate::ops::commands::retrieval::VectorModeMetadata,
    rrf_mode: bool,
...
struct FinalizeRetrievalInputs<'a> {
    ...
    query: &'a str,
    query_forms: &'a super::query_rewrite::AskQueryForms,
    mode: &'a crate::ops::commands::retrieval::VectorModeMetadata,
    retrieval_score_kind: AskExplainScoreKind,
