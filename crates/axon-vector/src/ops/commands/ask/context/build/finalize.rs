...
struct ExplainContextInputs<'a> {
    ...
    is_rrf: bool,
    final_source_order: Vec<axon_core::ask_explain::AskExplainContextSource>,
}
...
fn include_rendered_context(context: &str, explain_context: &mut AskExplainContext) {
    explain_context.rendered_context = Some(axon_core::ask_explain::AskExplainContextRendered {
        format: axon_core::ask_explain::AskExplainRenderedContextFormat::AxonSourcesV1,
