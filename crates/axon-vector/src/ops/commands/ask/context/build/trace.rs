...
pub(in crate::ops::commands::ask::context) struct CandidateSelectionKey {
    url: String,
    chunk_text: String,
}

pub(in crate::ops::commands::ask::context) fn candidate_selection_key(
...
#[allow(dead_code)]
pub(in crate::ops::commands::ask::context) struct ContextCandidateSelection {
    pub(in crate::ops::commands::ask::context) candidate_index: usize,
    pub(in crate::ops::commands::ask::context) key: CandidateSelectionKey,
    pub(in crate::ops::commands::ask::context) url: String,
    pub(in crate::ops::commands::ask::context) decisions: Vec<AskExplainSelectionDecision>,
    pub(in crate::ops::commands::ask::context) metadata: CandidateSelectionMetadata,
}

#[derive(Debug, Clone, PartialEq, Eq)]
pub(in crate::ops::commands::ask::context) struct CandidateSelectionMetadata {
    pub(in crate::ops::commands::ask::context) planned_full_doc_rank: Option<usize>,
    pub(in crate::ops::commands::ask::context) selected_context_rank: Option<usize>,
    pub(in crate::ops::commands::ask::context) insertion_mode: Option<AskExplainInsertionMode>,
}
