...
pub async fn ask_llm_streaming_with_runner<R>(
    runner: &R,
    cfg: &Config,
    query: &str,
    context: &str,
...
pub async fn ask_llm_streaming_tagged_with_runner<R>(
    runner: &R,
    cfg: &Config,
    query: &str,
    context: &str,
...
pub async fn ask_llm_non_streaming_with_runner<R>(
    runner: &R,
    cfg: &Config,
    query: &str,
    context: &str,
...
pub async fn baseline_llm_streaming_tagged_with_runner<R>(
    runner: &R,
    cfg: &Config,
    query: &str,
    stream: &'static str,
...
pub async fn baseline_llm_non_streaming_with_runner<R>(
    runner: &R,
    cfg: &Config,
    query: &str,
) -> Result<String, Box<dyn Error + Send + Sync>>
...
pub async fn judge_llm_non_streaming_with_runner<R>(
    runner: &R,
    cfg: &Config,
    ctx: &JudgeContext<'_>,
) -> Result<String, Box<dyn Error + Send + Sync>>
