...
use super::GitSourceIndexInput;
use super::git_source_adapter::{GitAdapterRun, normalize_changed_documents, timestamp};
use super::git_source_progress::{
    GitSourceProgress, progress_error_context, record_progress_with_reservations,
};

const GIT_CHANGED_DOCUMENT_BATCH_SIZE: usize = 64;
const GIT_CHANGED_CHUNK_BATCH_SIZE: usize = 512;
