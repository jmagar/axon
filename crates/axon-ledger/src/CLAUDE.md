...
- Do not add source fetching, parsing, embedding, vector writes, or cleanup
  execution.
- Update `../../../docs/pipeline-unification/crates/axon-ledger/README.md`, `../../../docs/pipeline-unification/runtime/ledger-contract.md`, and
  `../../../docs/pipeline-unification/schemas/database-schema.md` together.
