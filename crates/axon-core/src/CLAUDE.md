...
1. Extracts command-specific args (ask_diagnostics, github_include_source (default: true, disabled by `--no-source`; `--include-source` was removed as a no-op), reddit_*, sessions_*, serve_port)
