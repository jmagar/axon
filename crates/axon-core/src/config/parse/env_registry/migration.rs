...
pub(crate) const MIGRATION_ENV_KEY_SPECS: &[EnvKeySpec] = &[
    ...
    spec(
        ...
        MoveToml,
        NotRuntime,
        Some("tei.cooldown-after-failures"),
        WarnEnvOverride,
        false,
    ),
    spec(
    ...
    spec(
        ...
        MoveToml,
        NotRuntime,
        Some("tei.interactive-reserved-requests"),
        WarnEnvOverride,
        false,
    ),
    spec(
        ...
        MoveToml,
        NotRuntime,
        Some("tei.background-max-concurrent-requests"),
        WarnEnvOverride,
        false,
    ),
    spec(
        ...
        MoveToml,
        NotRuntime,
        Some("tei.maintenance-max-concurrent-requests"),
        WarnEnvOverride,
        false,
    ),
    spec(
        ...
        MoveToml,
        NotRuntime,
        Some("tei.query-instruction-enabled"),
        WarnEnvOverride,
        false,
    ),
    spec(
