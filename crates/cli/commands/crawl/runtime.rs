...
#[cfg(test)]
pub use crate::crates::crawl::chrome_bootstrap::ChromeBootstrapOutcome;

#[cfg(test)]
pub(super) fn chrome_runtime_requested(cfg: &Config) -> bool {
    crate::crates::crawl::chrome_bootstrap::chrome_runtime_requested(cfg)
}

#[cfg(test)]
pub(super) async fn bootstrap_chrome_runtime(cfg: &Config) -> ChromeBootstrapOutcome {
    crate::crates::crawl::chrome_bootstrap::bootstrap_chrome_runtime(cfg).await
}

#[cfg(test)]
pub(super) fn resolve_initial_mode(cfg: &Config) -> RenderMode {
    crate::crates::crawl::chrome_bootstrap::resolve_initial_mode(cfg)
}
