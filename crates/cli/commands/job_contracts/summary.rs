...
impl JobSummaryEntry {
    pub fn from_crawl(job: &crate::crates::jobs::crawl::CrawlJob) -> Self {
        super::record::SharedJobRecord::crawl(job).into()
    }

    pub fn from_extract(job: &crate::crates::jobs::extract::ExtractJob) -> Self {
        super::record::SharedJobRecord::extract(job).into()
    }

    pub fn from_ingest(job: &crate::crates::jobs::ingest::IngestJob) -> Self {
        super::record::SharedJobRecord::ingest(job).into()
    }

    pub fn from_embed(job: &crate::crates::jobs::embed::EmbedJob) -> Self {
        super::record::SharedJobRecord::embed(job).into()
    }

    pub fn from_service_job(job: &crate::crates::services::types::ServiceJob) -> Self {
