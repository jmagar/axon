...
use crate::crates::services::embed::embed_now_with_source;
use crate::crates::services::types::CrawlSyncResult;
...
async fn run_crawl_phase(
    ...
    let initial_mode = crate::crates::crawl::chrome_bootstrap::resolve_initial_mode(cfg);
