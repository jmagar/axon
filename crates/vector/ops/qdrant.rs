...
// Re-exported for the upcoming `migrate` command (Task 2 in the migrate feature).
// Suppressed until the caller is wired in.
#[allow(unused_imports)]
pub(crate) use client::qdrant_scroll_pages_with_vectors;
